...
bamsdir='/home/'
output_prefix=''
mkdir leafcutter leafcutter/juncs leafcutter/clusters leafcutter/differential_splicing_analysis
...
# 4. Differential intron excision analysis
cd ../differential_splicing_analysis
